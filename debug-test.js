...
async function debug() {
  ...
  console.log(
    'Has debug-app pages/index.tsx:',
    result.files.includes('apps/debug-app/pages/index.tsx'),
  );
  console.log(
    'Has debug-app lib/api-client.ts:',
    result.files.includes('apps/debug-app/lib/api-client.ts'),
  );
