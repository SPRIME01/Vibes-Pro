...
// App logs
log.info({ ...traceContext, category: 'app', user_id_hash: 'user_abc123' }, 'request accepted');

log.info({ ...traceContext, category: 'app', duration_ms: 45, status: 200 }, 'request completed');
...
console.log(
  'Expected fields in each line: timestamp, level, message, trace_id, span_id, service, environment, application_version, category',
);
