...
describe("hexDomainGenerator", () => {
  ...
  it("should generate the domain, application, and infrastructure layers", async () => {
    ...
    const infrastructureConfig = readProjectConfiguration(
      tree,
  ...
  it("should set the correct tags for each layer", async () => {
    ...
    expect(applicationConfig.tags).toEqual([
      "type:application",
      "domain:test-domain",
    ]);
    expect(infrastructureConfig.tags).toEqual([
      "type:infrastructure",
      "domain:test-domain",
    ]);
  });
  ...
  it("should create placeholder files with marker regions", async () => {
    ...
    const infrastructureIndexPath =
      "libs/test-domain/infrastructure/src/index.ts";
