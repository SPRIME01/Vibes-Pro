...
export class DatabaseSampleRepository implements SampleRepository {
  ...
  async save(entity: SampleEntity): Promise<void> {
    ...
    console.log(
      `Saving entity ${entity.id} to actual database at ${this.connectionString}`,
    );
  }
